...
public class QKART_Tests {
     ...
     */
    @Test(description = "Verify registration happens correctly", priority = 1, groups = { "Sanity_test" },dataProvider = "data-provider",dataProviderClass = DP.class)
    ...
    // @Optional("testUser") String TC2_Username, @Optional("abc@123") String TC2_Password
     ...
     */
    @Test(description = "Verify the functionality of search text box", priority = 3, groups = { "Sanity_test" },dataProvider = "data-provider",dataProviderClass = DP.class
    )
    // @Parameters("TC3_ProductNameToSearchFor")
    public void TestCase03(String TC1_ProductNameToSearchFor) throws InterruptedException {
        ...
        status = homePage.searchForProduct(TC1_ProductNameToSearchFor);
        assertTrue(status, "Unable to search for given product - " + TC1_ProductNameToSearchFor);
        ...
        assertFalse(searchResults.size() == 0,
                "There were no results for the given search string - " + TC1_ProductNameToSearchFor);
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertTrue(elementText.contains(TC1_ProductNameToSearchFor),
    ...
    public void TestCase07(String TC7_ListOfProductsToAddToCart) throws InterruptedException {
        ...
        softAssert.assertTrue(status, "Verifying cart contents after logging out and logging in failed");
    ...
    public void TestCase08(String TC8_ProductName, String TC8_Qty) throws InterruptedException {
        Boolean status;
        int ind=TC8_Qty.indexOf('.');
        String str=TC8_Qty.substring(0,ind);
        ...
        System.out.println("product quantity "+ Integer.parseInt(str) );
        homePage.changeProductQuantityinCart(TC8_ProductName, Integer.parseInt( str));
     ...
     */
    @Test(description = "Verify that the contact us dialog works fine", priority = 11, groups = { "Regression_Test" },dataProvider = "data-provider",dataProviderClass = DP.class
    )
    // @Parameters({ "TC11_ContactusUserName", "TC11_ContactUsEmail", "TC11_QueryContent" })
    public void TestCase11(String TC9_ContactusUserName, String TC9_ContactUsEmail, String TC9_QueryContent)
            throws InterruptedException {
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        ...
        name.sendKeys(TC9_ContactusUserName);
        WebElement email = driver.findElement(By.xpath("//input[@placeholder='Email']"));
        email.sendKeys(TC9_ContactUsEmail);
        WebElement message = driver.findElement(By.xpath("//input[@placeholder='Message']"));
        message.sendKeys(TC9_QueryContent);
