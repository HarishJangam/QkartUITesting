    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            for (WebElement cartItem : cartContents) {
                ...
                // System.out.print(cartItem.getText());
            }
            ...
            //     }
            // }
            int n=actualCartContents.size();
            if(n!=expectedCartContents.size()){
                return false;
            }
            for(int i=0;i<expectedCartContents.size();i++){
                System.out.println("expected "+expectedCartContents.get(i));
                System.out.println("actual "+actualCartContents.get(i));
                if(!expectedCartContents.get(i).equals(actualCartContents.get(i))){
                    return false;
                }
            }
            return true;
