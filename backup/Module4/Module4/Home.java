...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']")),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//h4[text()=' No products found ']"))));
            Thread.sleep(3000);//h4[text()=' No products found ']
            return true;
        } catch (Exception e) {
