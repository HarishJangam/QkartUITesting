...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        // Thread.sleep(3000);
        // ExpectException con1=ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar"));
        // ExpectException con2=ExpectedConditions.urlContains("/login"));

        WebDriverWait wait=new WebDriverWait(driver, 4);
        wait.until(ExpectedConditions.or(
            ExpectedConditions.presenceOfElementLocated(By.id("notistack-snackbar")),
